...
/*   Updated: 2024/06/06 11:10:59 by kbolon           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*begin_monitoring(void *arg)
{
	...
	{
		pthread_mutex_lock(&table->table_mutex);
		if (table->is_full || table->is_dead)
		{
			pthread_mutex_unlock(&table->table_mutex);
			break ;
